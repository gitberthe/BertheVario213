...
g_GlobalVar.m_TerrainPosCur.m_AltiBaro = 3500 ;
...
while( g_GlobalVar.m_TaskArr[SIMUVOL_NUM_TASK].m_Run )
    ...
    g_GlobalVar.m_TerrainPosCur.m_AltiBaro = alti ;
    g_GlobalVar.m_VitVertMS = (g_GlobalVar.m_TerrainPosCur.m_AltiBaro-LastAlti) * 2 ;
